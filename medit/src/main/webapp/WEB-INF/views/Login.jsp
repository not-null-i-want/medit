	        ...
	        <div class="center">
				<svg class="fingerprint" xmlns="http://www.w3.org/2000/svg" viewBox="-1.5 -1.5 136.63 136.56" width="136.63" height="136.56">
					...
					<linearGradient id="a" x1="49.4%" y1="-3.33%" x2="49.87%" y2="102.85%">
						<stop offset="0%" stop-color="#496fa7"/>
						<stop offset="90%" stop-color="#496fa7"/>
					</linearGradient>
				...
				<svg class="icon-success" viewBox="0 0 76 76">
					<circle cx="38" cy="38" r="36" fill="#496fa7"></circle>
					<path class="clone2" d="M17.7,40.9l10.9,10.9l28.7-28.7"></path>
				</svg>
				<div id="anno">Click and hold to login</div> 
			</div>
	    </form>
